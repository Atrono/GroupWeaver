...
public class SmokeTests
{
    ...
    {
        // Directory.Build.props pins <Version>0.1.0-dev</Version>; the App banner
        // (src/App/Program.cs) prints the informational version derived from it.
        // The SDK may append "+<commit>" via SourceLink, hence StartsWith.
        ...
        Assert.StartsWith("0.1.0-dev", informationalVersion);
    }
