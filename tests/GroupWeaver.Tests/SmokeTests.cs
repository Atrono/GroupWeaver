...
public class SmokeTests
{
    ...
    {
        // Directory.Build.props pins <Version>0.3.0</Version> (minor bump from
        // 0.2.1 — this release adds new features: in-graph find/controls, focus
        // mode, full-screen); the App banner (src/App/Program.cs) prints the
        ...
        Assert.StartsWith("0.3.0", informationalVersion);
    }
