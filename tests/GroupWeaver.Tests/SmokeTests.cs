...
public class SmokeTests
{
    ...
    {
        // Directory.Build.props pins <Version>0.3.1</Version> (patch bump from
        // 0.3.0 — viewport-preserving Back navigation, no new features); the App
        ...
        Assert.StartsWith("0.3.1", informationalVersion);
    }
